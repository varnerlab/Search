...
The main function of the ``Search`` package is ``estimate_model_parameters``:
    ...
    (objective_archive,parameter_archive) = estimate_model_parameters(objective_function::Function,generation_function::Function,acceptance_function::Function,constraints_function::Function,
